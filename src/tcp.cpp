...
int tcp_server_accept(struct tcp_server_t *server, struct sockaddr_in *client_addr, socklen_t *client_addr_len) {
...
void tcp_client_connect(struct tcp_client_t *client, const char *host,int port) {
